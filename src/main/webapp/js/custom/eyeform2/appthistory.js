jQuery(document).ready(function(){
	...
	jQuery("#apptHistoryTbl tr:gt(0)").each(function() {
		...
		jQuery(this).html("<td><input type=\"checkbox\" name=\"sel\" value=\""+jQuery(this).attr("appt_no")+"\" onclick='clickAppointmentCheckbox(this);'/></td>" + jQuery(this).html() + "<td><a href=\""+requestUrl+"\">Request</a>&nbsp;<a href=\""+reportUrl+"\">Report</a></td>");
	});
	
	//add button	
	jQuery("#apptHistoryTbl").append("<tr><td colspan=\"7\"><input type=\"button\" onclick=\"selectAllCheckboxes()\" value=\"Select All\"/>&nbsp;<input type=\"button\" onclick=\"deselectAllCheckboxes()\" value=\"Deselect All\"/><input type=\"button\" name='printVisitData' value=\"Print Visit Data\" onclick=\"printVisit()\"/></td></tr>");
