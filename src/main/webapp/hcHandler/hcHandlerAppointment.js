...
var _hc_apptScreenHandler = function(args) {
	...
	jQuery(window).find("#_hc_message, #_hc_read, #_hc_actions, #_hc_match, #_hc_noMatch").hide();
	...
	if (!(typeof args["error"] == "undefined")) {
		...
		jQuery(window).find("#_hc_closeBtn").show();
		
		
		jQuery(window).find("#_hc_status_text_success, #_hc_read, #_hc_layout, #_hc_matchSearch").show();
